  ...
  <div class="">
    ...
    <div class="flex flex-col gap-4 mb-[2.813rem]">
      <input v-model="depositAmount" placeholder="مبلغ را وارد کنید (حداقل مبلغ ۵۰،۰۰۰ تومان است)"
        class="rtl w-full border border-[#676767] focus:ring-0 text-white focus:border-white text-base font-normal leading-7 bg-black rounded-2xl placeholder-[#676767]">
      </input>
      <div class="flex gap-4">
        <div @click="setDepositAmount(500000)"
          class="cursor-pointer h-10 rounded-2xl text-base font-normal leading-7 text-white border border-[#676767] px-4 py-1.5 numDir">
          ۵ ، ۰۰۰ ، ۰۰۰</div>
    ...
    <div class="relative mb-7 text-white">
