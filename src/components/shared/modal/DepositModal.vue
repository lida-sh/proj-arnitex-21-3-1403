<template>
	<transition name="modal-fade" @before-enter="beforeEnter" @after-enter="afterEnter" @before-leave="beforeLeave"
		...
		<div v-if="isVisible" class="modal-overlay" @click.self="closeModal">
			<div class="modal-content bg-[#171717] ">
				<button class="close-button block ms-auto" @click="closeModal"><svg width="18" height="18" viewBox="0 0 18 18"
				...
				<div class="flex gap-[2rem] mt-[1.5rem]">
					<button class="bg-[#262626] flex  items-center gap-4 py-6 px-4 rounded-2xl w-[25rem]">
