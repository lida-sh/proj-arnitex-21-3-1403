        ...
        <div class="flex flex-col mt-7 gap-4">
          <div class="relative">
            <input type="text" placeholder="جستجو رمز ارز"
              class="pl-12 w-full bg-transparent rounded-lg border-1 border-white ps-3 text-white text-xs leading-6 font-medium placeholder:text-white py-2 px-1">
          ...
          <ul class="max-h-64 overflow-auto">
            <li v-for="item in coinList" :key="item" class="flex items-center hover:bg-[#000000] px-2 gap-4 border-solid border-b-[1px] border-[#BBBBBB]">
