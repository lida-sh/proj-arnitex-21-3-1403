...
<template>
  <div
    class="flex flex-col lg:flex-row items-cener mt-[6.563rem] mb-10 lg:w-[95rem] lg:px-[6.25rem] lg:mx-auto lg:gap-[21rem]">
      <div
        class="w-[20.5rem] lg:w-[10.5rem] h-[2.525rem] lg:h-[2.525rem] bg-[#262626] flex items-center justify-center py-[0.45rem]  px-[3.69rem] lg:px-2 rounded-[40px]">
        ...
        <div class="flex-1 cursor-pointer transition"
          :class="{ 'active-button': Cryptocurrency === 'Tether', 'inactive-button': Cryptocurrency !== 'Tether' }"
