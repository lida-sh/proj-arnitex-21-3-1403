    ...
    <div class="navigation">
      <div class="z-[100] fixed bottom-0 left-0 h-[4.5rem] w-full">
        <div class="relative flex h-full">
          ...
          <div class="absolute bottom-1 w-full text-white z-50 px-[40px]">
            <ul class="flex w-full justify-between items-end">
              <li>
                <NuxtLink href="#" @click="moveActiveTo(1)" :class="{ 'bottom-nav-link-selected': isActive(1) }" class="nav-link">
                  <IconsBottomNavigationHome></IconsBottomNavigationHome>
                  <span class="nav-link-text">خانه</span>
                </NuxtLink>
              </li>
              <li>
                <NuxtLink href="#" @click="moveActiveTo(2)" :class="{ 'bottom-nav-link-selected': isActive(2) }" class="nav-link">
                  <IconsBottomNavigationMarket></IconsBottomNavigationMarket>
                  <span class="nav-link-text">بازار</span>
                </NuxtLink>
              </li>
              <li>
                <NuxtLink href="#" @click="moveActiveTo(3)" :class="{ 'bottom-nav-link-selected': isActive(3) }" class="nav-link">
                  <IconsBottomNavigationTransaction></IconsBottomNavigationTransaction>
                  <span class="nav-link-text">معامله</span>
                </NuxtLink>
              </li>
              <li>
                <NuxtLink href="#" @click="moveActiveTo(4)" :class="{ 'bottom-nav-link-selected': isActive(4) }" class="nav-link">
                  <IconsBottomNavigationWallet></IconsBottomNavigationWallet>
                  <span class="nav-link-text">کیف پول</span>
                </NuxtLink>
              </li>
              <li>
                <NuxtLink href="#" @click="moveActiveTo(5)" :class="{ 'bottom-nav-link-selected': isActive(5) }" class="nav-link">
